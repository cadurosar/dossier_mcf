...
\titlestyle{Qualifié MCF sections 27, 61, 63}
\columnbreak
...
tél : (+33)6 88 62 06 03\\
32 ans
}
\end{multicols}
\vspace{0.2cm}
\subsection{Activité professionnelle actuelle}

\begin{flushleft}
\tabcv{2018 - 2019}{
\textbf{ATER}, \textit{Bordeaux INP}, \textit{laboratoire IMS}, \textit{Talence}\\[0.5em]
 {\footnotesize
 \textbf{$\bullet\ $Encadrants :} {Christophe Jégo (IMS), Camille Leroux (IMS)}\\
\textbf{$\bullet\ $Sujet :} {Implémentations logicielles et matérielles d'algorithmes de décodage de codes polaires}\\
\textbf{$\bullet\ $Enseignement :} {192 HETD de TP, TD et cours intégrés à l'ENSEIRB-MATMECA}
}
}
...
\tabcv{2015 - 2018}{
\textbf{Doctorat en électronique en cotutelle}, \\ \textit{Université de Bordeaux}, \textit{laboratoire IMS}, \textit{France}, \\ \textit{Polytechnique Montréal}, \textit{département de Génie \'Electrique}, \textit{Canada}\\[0.5em]
%\hbox{\phantom{\ \ \ \ }}\begin{minipage}{0.97\linewidth}
{\footnotesize \textbf{$\bullet\ $Sujet de thèse :} {Décodage de codes polaires sur des architectures programmables}\\
\textbf{$\bullet\ $Mots clefs :} {Codes polaires, décodeur logiciel, ASIP, adéquation algorithme-architecture}\\
\textbf{$\bullet$ Enseignement} : 45 HETD de TP, TD et cours intégrés à l'ENSEIRB-MATMECA\\
\textbf{$\bullet\ $Date de soutenance :} 13 décembre 2018\\
\textbf{$\bullet\ $Jury :} \\[0.25em]
\begin{tabular}{llll}
{Pr.} & {Mohamad Sawan}                    & {Polytechnique Montréal} & {Président} \\
{Pr.} & {Amer Baghdadi}                    & {IMT Atlantique}         & {Rapporteur}\\
{Pr.} & {Emmanuel Casseau} \textbf{(S.61)} & {Université Rennes 1}    & {Rapporteur} \\
...
{Pr.} & {Christophe Jégo}  \textbf{(S.61)} & {Bordeaux INP}           & {Directeur de thèse}\\
...
\tabcv{2012 - 2015}{
\textbf{Diplôme d'ingénieur}, \textit{ENSEIRB-MATMECA}, \textit{Talence}\\[0.5em]
{\footnotesize \textbf{$\bullet$ Cursus :} Systèmes \'Electroniques Embarqués (SEE)}, filière par apprentissage
}

\tabcv{2011 - 2012}{
\textbf{Diplôme Universitaire de Technologie}, \textit{IUT Paul Sabatier}, \textit{Toulouse}\\[0.5em]
{\footnotesize\textbf{$\bullet$ Spécialité :} Mesures Physiques }}

\subsection{Expériences professionnelles}

\tabcv{2012-2015}{
\textbf{Ingénieur en apprentissage}, \textit{Worldcast Systems}, \textit{Mérignac}\\[0.5em]
{\footnotesize
\textbf{$\bullet$ Encadrant} : Hervé Garat\\
\textbf{$\bullet$ Sujet du mémoire} : Conception d'une interface homme-machine pour des émetteurs radio \\
\textbf{$\bullet$ Activités annexes} : Programmation microcontrôleur d'émetteurs FM
...
\textbf{$\bullet$ Sujet :} Conception d'une jauge électronique dotée d'un afficheur pour mesure de niveau dans une cuve à l'aide d'un capteur de pression différentielle
}
}
...
\item \textbf{Conférences Nationales}
...
En juin 2015, j'ai participé à la journée \og Technologies pour la 5G - segment spatial \fg organisée par le CNES à Toulouse, pour une présentation nommée \og Les codes polaires, algorithmes et décodeurs \fg, durant laquelle j'ai pu échanger avec les différents intervenants. 
