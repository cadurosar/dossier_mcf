...
\item[Contenu :] Cet enseignement a pour but de renforcer les connaissances en abordant des techniques plus avancées relatives aux processeurs et aux mémoires. Ce cours est articulé autour du livre de J.L. Hennessy et A. Patterson "Computer Architecture, a quantitative approach". Sont abordés les architectures RISC et CISC, les architecture pipeline, les aléas de données et de contrôle. Le cas du processeur MIPS est étudié en détail pour donner aux étudiants un exemple concret d'architecture de processeur.
