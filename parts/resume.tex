...
{\footnotesize\textbf{$\bullet$ Spécialité:} Physical measures}}
...
\textbf{$\bullet\ $Sujet:} {Software and hardware implementations of polar decoding algorithms}\\
\textbf{$\bullet\ $Enseignement:} {192 hours at Bordeaux INP Engineering School}
}
}
