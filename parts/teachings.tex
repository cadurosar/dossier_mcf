...
\hline
\textbf{School} & \textbf{Année scolaire} & \textbf{Vol. horaire éq. TD} & \textbf{Section} \\ \hline \hline
...
\item[Person in charge:] Mathieu Léonardon
...
\item[Personal Participation:] Integrated Course - TD
...
\label{subsubsec:en1}
\begin{description}\parskip 0pt
\item[Person in charge:] Christophe Jégo
%\item[Enrolment:] About 15 students
\item[Level :] First year ENSEIRB-MATMECA - equivalent L3
...
\item[Personal participation:] Supervision of the TPs and the project
\end{description}

\noindent \subsubsection{Microprocessor project}
\begin{description}\parskip 0pt
\item[Person in charge:] Valéry Lebret
\item[Level :] First year ENSEIRB-MATMECA - equivalent L3
...
\begin{description}\parskip 0pt
\item[Person in charge:] Jérémie Crenne
\item[Level :] Second year ENSEIRB-MATMECA - equivalent M1
...
\item[Keywords:] Computer architecture, pipeline architectures, multifilament
\item[Personal Involvement :] Supervision of TDs
\end{description}
...
\item[Content :] 
All TPs are performed on the AT91SAM7X256 microcontroller. This microcontroller has an ARM7 core, many peripherals and a vectorized and configurable interrupt system.
...
The concepts covered cover real-time aspects, communication, data integrity.
